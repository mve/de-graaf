...
$factory->define(Product::class, function (Faker $faker) {
    $courses = ['Hoofdgerecht', 'Voorgerecht', 'Desert'];
    $subcourse = ['Warm voorgerecht', 'Koud voorgerecht', 'Vis'];

    return [
        'name' => $faker->name,
        'price' => $faker->randomDigit,
        'main_course' => $courses[random_int(0,2)],
        'sub_course' => $courses[random_int(0,2)],
