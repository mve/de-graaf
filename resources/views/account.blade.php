        ...
        <div class="row">
            ...
            <form method="post" action="{{route('account.edit', $user)}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="address" type="text" value="{{ $user->address }}" class="form-control  @error('address') is-invalid @enderror" name="address" placeholder="Straat"   autocomplete="adress" autofocus>
                        @error('address')
                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
